                ...
                @if($role === 'kasir')
                    ...
                    <a href="{{ route('cashier.tables') }}" 
                       ...
                       :class="(!isMobile && !sidebarOpen) ? 'justify-center !px-0' : ''">
                        ...
                        <span class="sidebar-text whitespace-nowrap overflow-hidden transition-all duration-300 font-bold text-[10px] uppercase tracking-[0.2em]" 
                              :class="(isMobile && mobileMenu) || (!isMobile && sidebarOpen) ? 'opacity-100 max-w-xs' : 'opacity-0 max-w-0 pointer-events-none'">Ketersediaan Meja</span>
                    </a>
                @endif
                ...
                @if($role === 'barista')
                    ...
                    <a href="{{ route('barista.menus') }}" 
                       ...
                       :class="(!isMobile && !sidebarOpen) ? 'justify-center !px-0' : ''">
                        ...
                        <span class="sidebar-text whitespace-nowrap overflow-hidden transition-all duration-300 font-bold text-[10px] uppercase tracking-[0.2em]" 
                              :class="(isMobile && mobileMenu) || (!isMobile && sidebarOpen) ? 'opacity-100 max-w-xs' : 'opacity-0 max-w-0 pointer-events-none'">Kelola Stok Menu</span>
                    </a>
                @endif
