...
@section('title', 'Kelola Pemesanan - Barista')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-12">
        <div>
            ...
            <h1 class="text-5xl md:text-6xl font-bold text-stone-900 font-heading uppercase tracking-tight">Kelola Pemesanan</h1>
            <p class="text-xs font-semibold text-stone-400 uppercase tracking-widest mt-4">Kelola antrean dan kerjakan pesanan pelanggan</p>
        </div>
