...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-12">
        <div>
            ...
            <h1 class="text-5xl md:text-6xl font-bold text-stone-900 font-heading uppercase tracking-tight">Dashboard Barista</h1>
    ...
    <div class="py-32 flex flex-col items-center justify-center gap-6 bg-white rounded-[40px] border border-stone-100 shadow-sm border-dashed">
        ...
        <div class="text-center max-w-md mx-auto">
            ...
            <p class="text-xs font-semibold text-stone-400 uppercase tracking-widest leading-relaxed">Silakan gunakan menu navigasi di samping untuk mengelola pemesanan pelanggan dan kontrol stok.</p>
        </div>
    </div>
</div>
@endsection
