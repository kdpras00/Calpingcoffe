...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-stone-800 dark:text-stone-100">Tambah Menu Baru</h1>
        <p class="text-stone-500 dark:text-stone-400 mt-1">Tambahkan item menu baru ke katalog</p>
    </div>
